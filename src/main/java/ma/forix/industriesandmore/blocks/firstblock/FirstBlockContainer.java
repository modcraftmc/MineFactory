package ma.forix.industriesandmore.blocks.firstblock;
...
import static ma.forix.industriesandmore.blocks.ModBlocks.FIRSTBLOCK_CONTAINER;
...
public class FirstBlockContainer extends Container {
    ...
    public FirstBlockContainer(int id, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
